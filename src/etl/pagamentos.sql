...
SELECT idVendedor,
       ...
       SUM(CASE WHEN descTipoPagamento = 'not_defined' THEN qtdPedidoMeioPagamento ELSE 0 END) AS qtd_not_defined_pedido,
       ...
       SUM(CASE WHEN descTipoPagamento = 'not_defined' THEN vlPedidoMeioPagamento  ELSE 0 END) AS valor_not_defined_pedido,
       ...
       SUM(CASE WHEN descTipoPagamento = 'not_defined' THEN qtdPedidoMeioPagamento ELSE 0 END) / SUM(qtdPedidoMeioPagamento) AS pct_qtd_not_defined_pedido,
       ...
       SUM(CASE WHEN descTipoPagamento = 'not_defined' THEN vlPedidoMeioPagamento  ELSE 0 END) / SUM(vlPedidoMeioPagamento) AS pct_valor_not_defined_pedido,
